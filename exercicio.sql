...
insert into funcionarios values (1001,'Alvise','schenorberger123@gmail.com','Masculino','EstágioBD','5/2/2024',1500,'Estagiario',1);
...
select departamento, nome, email, sexo from funcionarios
...
where departamento='estagiobd';

select count(*) from funcionarios;

select count(*), departamento from funcionarios
where (departamento ='estagiobd' and sexo='masculino') or (departamento='filmes' and sexo='masculino')
group by departamento;

select idFuncionario, nome, departamento, email from funcionarios
where departamento='estagiobd' or (departamento='filmes' and sexo='masculino');

select idFuncionario, nome, salario from funcionarios
where departamento='industrial'
order by 1,3;
