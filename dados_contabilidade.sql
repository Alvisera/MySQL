...
insert into setores (areas) values ('Contabilidade Gerencial');
insert into setores (areas) values ('Consultoria Financeira');
insert into setores (areas) values ('Gestão de Riscos');
insert into setores (areas) values ('Contabilidade de Custos');
insert into setores (areas) values ('Serviços de Payroll');
insert into setores (areas) values ('Serviços de Compliance');
insert into setores (areas) values ('Serviços de Planejamento Tributário');
insert into setores (areas) values ('Contabilidade de Gestão');
insert into setores (areas) values ('Analista de dados');
insert into setores (areas) values ('Contabilidade Forense');
insert into setores (areas) values ('Tecnologia da Informação');
